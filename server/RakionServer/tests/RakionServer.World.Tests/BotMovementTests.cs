...
namespace RakionServer.World.Tests
{
    ...
    public class BotMovementTests
    {
        ...
        public void BuildCreateNpcDatagram_WrapsBody_WithTransportHeader()
        {
            ...
            // [u16 0x8307 RELIABLE][u32 seq][u8 srcSlot][corpo: 28B header + 15B blob] = 50B (= captura real).
            // Reliable é o único formato que renderiza; o render fica consistente com o peer BLINDADO em modo NPC.
            Assert.Equal(50, d.Length);
            Assert.Equal(0x07, d[0]); Assert.Equal(0x83, d[1]);    // msgType 0x8307 (LE) — RELIABLE (bit 0x8000)

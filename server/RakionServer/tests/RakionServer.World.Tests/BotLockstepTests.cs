...
namespace RakionServer.World.Tests
{
    ...
    {
        [Fact]
        public void Open_do_joiner_bate_com_a_captura_l12()
        {
            // l.12: 2302->2301, seq=4, dst=host seat 0, token 0x02f806e7
            byte[] open = BotLockstep.BuildOpen(4, 0x00, 0x02f806e7);
            Assert.Equal("040304000000FF00E706F802", Convert.ToHexString(open));
        }

        [Fact]
        public void Push_do_joiner_bate_com_a_captura_l16()
        {
            // l.16: 2302->2301, seq=7, src=joiner seat 0x0a, dst=host seat 0, token 0x02f827f9, payload=seat
            byte[] push = BotLockstep.BuildPush(7, 0x0a, 0x00, 0x02f827f9);
            Assert.Equal("0403070000000A00F927F8020A", Convert.ToHexString(push));
        }

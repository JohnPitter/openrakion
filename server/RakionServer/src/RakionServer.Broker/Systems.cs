...
namespace BrokenServer
{
	...
	public class Systems
	{
		...
		{
			// Token: 0x06000031 RID: 49 RVA: 0x00002218 File Offset: 0x00000418
			public ProfileChangedArgs(Systems.ProfileChangeType changeType, string section, string entry, object value)
			{
			...
			// (get) Token: 0x06000032 RID: 50 RVA: 0x0000223D File Offset: 0x0000043D
			public Systems.ProfileChangeType ChangeType
			{
				get
				{
			...
			// (get) Token: 0x06000033 RID: 51 RVA: 0x00002245 File Offset: 0x00000445
			...
			// (get) Token: 0x06000034 RID: 52 RVA: 0x0000224D File Offset: 0x0000044D
			public string Entry
			{
				get
				{
			...
			// (get) Token: 0x06000035 RID: 53 RVA: 0x00002255 File Offset: 0x00000455
			public object Value
			{
				get
				{
			...
			private readonly Systems.ProfileChangeType m_changeType;
		...
		public class ProfileChangingArgs : Systems.ProfileChangedArgs
		{
			// Token: 0x06000036 RID: 54 RVA: 0x0000225D File Offset: 0x0000045D
			public ProfileChangingArgs(Systems.ProfileChangeType changeType, string section, string entry, object value)
				: base(changeType, section, entry, value)
			{
			}

			// Token: 0x1700000A RID: 10
			// (get) Token: 0x06000037 RID: 55 RVA: 0x0000226A File Offset: 0x0000046A
			// (set) Token: 0x06000038 RID: 56 RVA: 0x00002272 File Offset: 0x00000472
			public bool Cancel
			{
				get
				{
		...
		public delegate void ProfileChangingHandler(object sender, Systems.ProfileChangingArgs e);

		// Token: 0x0200000E RID: 14
		// (Invoke) Token: 0x0600003E RID: 62
		public delegate void ProfileChangedHandler(object sender, Systems.ProfileChangedArgs e);
		...
		public interface IProfile : Systems.IReadOnlyProfile, ICloneable
		{
			...
			Systems.IReadOnlyProfile CloneReadOnly();

			// Token: 0x14000002 RID: 2
			// (add) Token: 0x06000056 RID: 86
			// (remove) Token: 0x06000057 RID: 87
			event Systems.ProfileChangingHandler Changing;

			// Token: 0x14000003 RID: 3
			// (add) Token: 0x06000058 RID: 88
			// (remove) Token: 0x06000059 RID: 89
			event Systems.ProfileChangedHandler Changed;
		}

		// Token: 0x02000011 RID: 17
		public abstract class Profile : Systems.IReadOnlyProfile, Systems.IProfile, ICloneable
		{
			// Token: 0x14000004 RID: 4
			// (add) Token: 0x0600005A RID: 90 RVA: 0x000037EC File Offset: 0x000019EC
			// (remove) Token: 0x0600005B RID: 91 RVA: 0x00003824 File Offset: 0x00001A24
			public event Systems.ProfileChangingHandler Changing;

			// Token: 0x14000005 RID: 5
			// (add) Token: 0x0600005C RID: 92 RVA: 0x0000385C File Offset: 0x00001A5C
			// (remove) Token: 0x0600005D RID: 93 RVA: 0x00003894 File Offset: 0x00001A94
			public event Systems.ProfileChangedHandler Changed;

			// Token: 0x0600005E RID: 94 RVA: 0x0000227B File Offset: 0x0000047B
			protected Profile()
			{
				this.m_name = this.DefaultName;
			}

			// Token: 0x0600005F RID: 95 RVA: 0x0000228F File Offset: 0x0000048F
			protected Profile(string name)
			{
				this.m_name = name;
			}

			// Token: 0x06000060 RID: 96 RVA: 0x0000229E File Offset: 0x0000049E
			protected Profile(Systems.Profile profil)
			{
				this.m_name = profil.m_name;
				this.m_readOnly = profil.m_readOnly;
				this.Changing = profil.Changing;
				this.Changed = profil.Changed;
			}

			// Token: 0x1700000F RID: 15
			// (get) Token: 0x06000061 RID: 97 RVA: 0x000022D6 File Offset: 0x000004D6
			// (set) Token: 0x06000062 RID: 98 RVA: 0x000038CC File Offset: 0x00001ACC
			public string Name
			{
				get
				{
				...
				set
				{
					...
					if (this.m_name == value.Trim())
					{
						return;
					}
					if (!this.RaiseChangeEvent(true, Systems.ProfileChangeType.Name, null, null, value))
					{
						return;
					}
					this.m_name = value.Trim();
					this.RaiseChangeEvent(false, Systems.ProfileChangeType.Name, null, null, value);
				}
			}

			// Token: 0x17000010 RID: 16
			// (get) Token: 0x06000063 RID: 99 RVA: 0x000022DE File Offset: 0x000004DE
			// (set) Token: 0x06000064 RID: 100 RVA: 0x000022E6 File Offset: 0x000004E6
			public bool ReadOnly
			{
				...
				set
				{
					...
					if (!this.RaiseChangeEvent(true, Systems.ProfileChangeType.ReadOnly, null, null, value))
					{
						return;
					}
					this.m_readOnly = value;
					this.RaiseChangeEvent(false, Systems.ProfileChangeType.ReadOnly, null, null, value);
				}
			}
			...
			// Token: 0x0600006A RID: 106 RVA: 0x00003940 File Offset: 0x00001B40
			...
			// Token: 0x0600006C RID: 108 RVA: 0x000039C0 File Offset: 0x00001BC0
			...
			// Token: 0x0600006D RID: 109 RVA: 0x000039FC File Offset: 0x00001BFC
			...
			public virtual Systems.IReadOnlyProfile CloneReadOnly()
			{
				Systems.Profile profile = (Systems.Profile)this.Clone();
				profile.m_readOnly = true;
				return profile;
			}

			// Token: 0x06000074 RID: 116 RVA: 0x00003A80 File Offset: 0x00001C80
			public virtual DataSet GetDataSet()
			{
				...
				{
					DataTable dataTable = dataSet.Tables.Add(text);
					string[] entryNames = this.GetEntryNames(text);
					DataColumn[] array2 = new DataColumn[entryNames.Length];
					object[] array3 = new object[entryNames.Length];
					int num = 0;
					foreach (string text2 in entryNames)
					{
						object value = this.GetValue(text, text2);
						array2[num] = new DataColumn(text2, value.GetType());
						array3[num++] = value;
					}
			...
			// Token: 0x06000075 RID: 117 RVA: 0x00003B60 File Offset: 0x00001D60
				...
				foreach (object obj in ds.Tables)
				{
					...
					if (rows.Count != 0)
					{
						foreach (object obj2 in dataTable.Columns)
						{
							...
							object obj3 = rows[0][dataColumn];
							this.SetValue(tableName, columnName, obj3);
						}
					}
				}
			}
			...
			// (get) Token: 0x06000076 RID: 118 RVA: 0x00003C50 File Offset: 0x00001E50
			protected string DefaultNameWithoutExtension
			{
				get
				{
					...
					try
					{
						string configurationFile = Environment.ProcessPath ?? "profile.exe"; // net9: substitui AppDomainSetup.ConfigurationFile
						text = configurationFile.Substring(0, configurationFile.LastIndexOf('.'));
					}
					catch
					{
						text = "profile";
			...
			// Token: 0x06000077 RID: 119 RVA: 0x00002323 File Offset: 0x00000523
			...
			// Token: 0x06000078 RID: 120 RVA: 0x0000233D File Offset: 0x0000053D
			...
			// Token: 0x06000079 RID: 121 RVA: 0x00002357 File Offset: 0x00000557
			...
			// Token: 0x0600007A RID: 122 RVA: 0x0000237E File Offset: 0x0000057E
			...
			// Token: 0x0600007B RID: 123 RVA: 0x00003C9C File Offset: 0x00001E9C
			protected bool RaiseChangeEvent(bool changing, Systems.ProfileChangeType changeType, string section, string entry, object value)
			{
				if (!changing)
				{
					if (this.Changed != null)
					{
						this.OnChanged(new Systems.ProfileChangedArgs(changeType, section, entry, value));
					}
					return true;
				}
				...
				Systems.ProfileChangingArgs profileChangingArgs = new Systems.ProfileChangingArgs(changeType, section, entry, value);
				this.OnChanging(profileChangingArgs);
				return !profileChangingArgs.Cancel;
			}

			// Token: 0x0600007C RID: 124 RVA: 0x00003CF0 File Offset: 0x00001EF0
			protected virtual void OnChanging(Systems.ProfileChangingArgs e)
			{
				if (this.Changing == null)
				{
					return;
				}
				foreach (Systems.ProfileChangingHandler profileChangingHandler in this.Changing.GetInvocationList())
				{
					profileChangingHandler(this, e);
					if (e.Cancel)
					{
						return;
					}
			...
			// Token: 0x0600007D RID: 125 RVA: 0x00002393 File Offset: 0x00000593
			protected virtual void OnChanged(Systems.ProfileChangedArgs e)
			{
				if (this.Changed != null)
				{
					this.Changed(this, e);
		...
		public class Ini : Systems.Profile
		{
			// Token: 0x0600007E RID: 126 RVA: 0x000023AA File Offset: 0x000005AA
			public Ini()
			{
			}
			...
			public Ini(Systems.Ini ini)
				: base(ini)
			{
			}

			// Token: 0x17000013 RID: 19
			// (get) Token: 0x06000081 RID: 129 RVA: 0x000023C4 File Offset: 0x000005C4
			public override string DefaultName
			{
				get
				{
					return base.DefaultNameWithoutExtension + ".ini";
				}
			}

			// Token: 0x06000082 RID: 130 RVA: 0x000023D6 File Offset: 0x000005D6
			public override object Clone()
			{
				return new Systems.Ini(this);
			}
			...
			public override void SetValue(string section, string entry, object value)
			{
				...
				this.VerifyAndAdjustSection(ref section);
				this.VerifyAndAdjustEntry(ref entry);
				if (!base.RaiseChangeEvent(true, Systems.ProfileChangeType.SetValue, section, entry, value))
				{
					return;
				}
				if (Systems.Ini.WritePrivateProfileString(section, entry, value.ToString(), base.Name) == 0)
				{
					throw new Win32Exception();
				}
				base.RaiseChangeEvent(false, Systems.ProfileChangeType.SetValue, section, entry, value);
			}
			...
			public override object GetValue(string section, string entry)
			{
				...
				for (;;)
				{
					...
					privateProfileString = Systems.Ini.GetPrivateProfileString(section, entry, "", stringBuilder, num, base.Name);
				...
				if (privateProfileString == 0 && !this.HasEntry(section, entry))
				{
					return null;
				}
			...
			// Token: 0x0600008B RID: 139 RVA: 0x00003E10 File Offset: 0x00002010
			public override void RemoveEntry(string section, string entry)
			{
				...
				this.VerifyAndAdjustSection(ref section);
				this.VerifyAndAdjustEntry(ref entry);
				if (!base.RaiseChangeEvent(true, Systems.ProfileChangeType.RemoveEntry, section, entry, null))
				{
					return;
				}
				if (Systems.Ini.WritePrivateProfileString(section, entry, 0, base.Name) == 0)
				{
					throw new Win32Exception();
				}
				base.RaiseChangeEvent(false, Systems.ProfileChangeType.RemoveEntry, section, entry, null);
			}

			// Token: 0x0600008C RID: 140 RVA: 0x00003E74 File Offset: 0x00002074
			public override void RemoveSection(string section)
			{
				...
				this.VerifyName();
				this.VerifyAndAdjustSection(ref section);
				if (!base.RaiseChangeEvent(true, Systems.ProfileChangeType.RemoveSection, section, null, null))
				{
					return;
				}
				if (Systems.Ini.WritePrivateProfileString(section, 0, "", base.Name) == 0)
				{
					throw new Win32Exception();
				}
				base.RaiseChangeEvent(false, Systems.ProfileChangeType.RemoveSection, section, null, null);
			}

			// Token: 0x0600008D RID: 141 RVA: 0x00003ED4 File Offset: 0x000020D4
			public override string[] GetEntryNames(string section)
			{
				...
				{
					array = new byte[num];
					privateProfileString = Systems.Ini.GetPrivateProfileString(section, 0, "", array, num, base.Name);
					if (privateProfileString < num - 2)
					{
						break;
					}
					num *= 2;
				}
				string @string = Encoding.ASCII.GetString(array, 0, privateProfileString - ((privateProfileString > 0) ? 1 : 0));
				if (@string == "")
				{
					return new string[0];
				}
				...
				return text.Split(array2);
			}

			// Token: 0x0600008E RID: 142 RVA: 0x00003F60 File Offset: 0x00002160
			public override string[] GetSectionNames()
			{
				...
				{
					array = new byte[num];
					privateProfileString = Systems.Ini.GetPrivateProfileString(0, "", "", array, num, base.Name);
					if (privateProfileString < num - 2)
					{
						break;
					}

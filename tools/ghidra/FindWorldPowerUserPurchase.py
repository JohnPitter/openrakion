# -*- coding: utf-8 -*-
# Localiza SQL e fluxo de compra/cupom do Power User no World original.
# Saida: C:\temp\world_power_user_purchase.txt
# @category Rakion
from ghidra.app.decompiler import DecompInterface
from ghidra.util.task import ConsoleTaskMonitor

KEYWORDS = ["logbuypoweruser", "powertimedate", "powerlevelpoint_cur"]
...
with open(r"C:\temp\world_power_user_purchase.txt", "w") as output:
...
print("world power user purchase: %d strings, %d funcoes" %

# -*- coding: utf-8 -*-
# Localiza consumidores das tabelas de cash e contabilidade no World original.
# Saida: C:\temp\world_cash_accounting.txt
# @category Rakion
from ghidra.app.decompiler import DecompInterface
from ghidra.util.task import ConsoleTaskMonitor

KEYWORDS = [
    "localsales", "localserverstatus", "logaddgoldcash", "logbuycashitem",
    "logincash", "logspendgoldcash", "insert into cash", "update cash",
    "select cash", "cash_prev", "cash_cur"
]
...
with open(r"C:\temp\world_cash_accounting.txt", "w") as output:
...
print("world cash accounting: %d strings, %d funcoes" %

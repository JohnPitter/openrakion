...
`SetNickname` já existente no `Buddy2.dll` após cada seleção e abertura do F9, aguardando o
primeiro `RET_LOGIN` quando necessário e sem duplicar a solicitação entre os dois callbacks. Os dados e a lista

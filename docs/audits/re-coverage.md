...
| 10 | [`systems/gameplay/cells-creatures-npc.md`](../systems/gameplay/cells-creatures-npc.md), [`npc-stat-curves.md`](../systems/gameplay/npc-stat-curves.md), [`npc-family-nak.md`](../systems/gameplay/npc-family-nak.md), [`npc-family-panzer.md`](../systems/gameplay/npc-family-panzer.md), [`npc-family-crossbow.md`](../systems/gameplay/npc-family-crossbow.md) e [`npc-family-blazer.md`](../systems/gameplay/npc-family-blazer.md) | RE estático e compatibilidade headless completos; dinâmica visual pendente | golden source: 47 tipos/99 níveis, 43 classes carregáveis; `NpcBlackDragon*` ausente. Curvas, CP, slots, targeting, friendly fire e dano comum estão provados. Nak fecha 29 eventos e poison; Panzer fecha 34 e stab/lash; CrossBow fecha 30 base, cinco exclusivos e flecha; Blazer fecha 13 eventos, FireBall, faixa `50`, probe `20`, delay `3` e emissores das mãos. Init, 269 eventos, late join e parsers `0x8307/08/09/0B/0C/10/12` estão fechados. Faltam goldens runtime, efeitos/hitboxes exatos, famílias após Blazer e validação gráfica; autoridade server-side é opcional |

...
| 26 | [`protocol/client-integrity.md`](../protocol/client-integrity.md) | RE completo desta build; proteção moderna headless | GameGuard separado; login/ChCode, MD5 global, modos, `BB/BC`, feature flag e probes fechados. Imports, vtable e consumidores de `_pRakionWorldNet` provam ChCode sem call site e packet-speed como no-op dormente. Update assinado e ticket vinculado a app/build implementam o gate de rollout; 760 testes World e 11 do launcher passam. Validação visual segue pendente; autoridade de combate/economia pertence aos respectivos subsistemas |

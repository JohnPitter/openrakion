...
| 10 | [`systems/gameplay/cells-creatures-npc.md`](../systems/gameplay/cells-creatures-npc.md), [`npc-stat-curves.md`](../systems/gameplay/npc-stat-curves.md), [`npc-family-nak.md`](../systems/gameplay/npc-family-nak.md), [`npc-family-panzer.md`](../systems/gameplay/npc-family-panzer.md) e [`npc-family-crossbow.md`](../systems/gameplay/npc-family-crossbow.md) | RE estático e compatibilidade headless completos; dinâmica visual pendente | golden source: 47 tipos/99 níveis, 43 classes carregáveis; `NpcBlackDragon*` ausente. As 24 séries de `creatures.dat` fecham os 8.118 bytes e Attack é a base de dano. CP/custo, slots, targeting, friendly fire e dano comum estão provados. Nak fecha 29 eventos e poison; Panzer fecha 34 eventos e stab/lash; CrossBow fecha 30 eventos base, cinco exclusivos da variante 2, FireKick, flecha e faixas `10/50`. Init, 269 eventos, late join e parsers `0x8307/08/09/0B/0C/10/12` estão fechados. Faltam goldens runtime, efeitos/hitboxes exatos, famílias após CrossBow e validação gráfica; autoridade server-side é opcional |

# Guia de setup legado — Servidor Rakion v258

> **Histórico:** este fluxo PHP/Python foi substituído pelos serviços .NET. Para instalação atual,
> use [`../../server/RakionServer/TUTORIAL.md`](../../server/RakionServer/TUTORIAL.md).

Passo a passo histórico para subir o servidor e logar. Pressupõe que você **já tem os arquivos
originais do Rakion**. Veja [`../../NOTICE.md`](../../NOTICE.md).
...
2. Adicione **`PMReaderLib.dll`** e o **`config.xfs` gerado** (veja
   [`../guides/config-xfs.md`](../guides/config-xfs.md)) em `client/Bin/`.
